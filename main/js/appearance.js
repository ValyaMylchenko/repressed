$(document).ready(function() {
    ...
    $("body").fadeIn(2500); /** время появления в миллисекундах */
     
    $("a.connect").click(function(event){ /** a.fade означает, что данное решение будет работать только при нажатии на ссылки с классом (class) "fade" (можно изменить на свой) */
